...
def addGroupPoint : AddGroup₁ Point where
  ...
  zero := zero
  neg := neg
  add_assoc := by unfold add; simp [add_assoc]
  add_zero := by unfold add zero; simp
  zero_add := by unfold add zero; simp
  neg_add_cancel := by unfold neg add zero; simp
...
instance : AddGroup₂ Point where
  ...
  zero := Point.zero
  neg := Point.neg
  add_assoc := by unfold Point.add; simp [add_assoc]
  add_zero := by unfold Point.add Point.zero; simp
  zero_add := by unfold Point.add Point.zero; simp
  neg_add_cancel := by unfold Point.neg Point.add Point.zero; simp
